...
void printHelp() {
  ...
  Serial.println("═══════════════════════════════════════");
  Serial.println("Sistem toggle modda çalışır (x değişkeni):");
  Serial.println("• x=0 → Butona bas → AÇILIR (x=1)");
  Serial.println("  └─> 001.mp3 → URL Liste 1 → Sonuç sesi");
  Serial.println("• x=1 → Butona bas → KAPANIR (x=0)");
  Serial.println("  └─> 005.mp3 → URL Liste 2");
  Serial.println("\nSonuç sesleri (AÇMA için):");
  Serial.println("• Başarılı: 002.mp3");
  Serial.println("• İnternet yok: 003.mp3 + 004.mp3");
  Serial.println("• Hata: 004.mp3\n");
  
  Serial.println("⚠️  NOT: Cihaz her açıldığında x=0 olur\n");
}
